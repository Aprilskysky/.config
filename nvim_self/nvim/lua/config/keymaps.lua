...
map("n", "<leader>rv", "<cmd>restart<CR>", { noremap = true, silent = true, desc = "neovim restart" })
map("n", "<leader>ms", "<cmd>messages<CR>", { noremap = true, silent = true, desc = "neovim messages" })
